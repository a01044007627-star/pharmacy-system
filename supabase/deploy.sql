...
-- ===== 20260621001000_full_operational_closure.sql =====
BEGIN;
...
-- ===== 20260621002000_end_to_end_operations_closure.sql =====
BEGIN;
...
-- ===== 20260621003000_patient_visits_partner_opening_hardening.sql =====
BEGIN;
...
-- ===== 20260621004000_void_accounting_and_returns_hardening.sql =====
BEGIN;
...
-- ===== 20260621005000_sales_return_void_and_offline_hardening.sql =====
BEGIN;
...
-- ===== 20260621006000_partner_update_accounting_and_integrity.sql =====
BEGIN;
...
-- ===== 20260621007000_atomic_accounting_closeout.sql =====
BEGIN;
...
-- ===== 20260621008000_atomic_shifts_and_expenses.sql =====
BEGIN;
...
-- ===== 20260621009000_atomic_complete_business_documents.sql =====
BEGIN;
...
-- ===== 20260621010000_atomic_complete_voids.sql =====
BEGIN;
...
-- ===== 20260621110000_final_tenancy_security_offline_repair.sql =====
...
-- ===== 20260621115000_cashier_experience_operational_repair.sql =====
BEGIN;
