...
import { ArrowRight, Edit, ExternalLink, Loader2, Package, ShieldCheck } from "lucide-react"
        ...
        <DashboardPageHeader
          ...
          actions={
            <div className="flex flex-wrap gap-2">
              ...
              <Button variant="outline" className="h-10 rounded-xl" render={<Link href={`/dashboard/items/variants`} />}><Package className="size-4" /> المتغيرات</Button>
